  ...
  fromJSON(object: any): DescriptorProto {
    return {
      ...
      extensionRange: globalThis.Array.isArray(object?.extensionRange)
        ? object.extensionRange.map((e: any) => DescriptorProtoExtensionRange.fromJSON(e))
        : [],
      ...
      reservedRange: globalThis.Array.isArray(object?.reservedRange)
        ? object.reservedRange.map((e: any) => DescriptorProtoReservedRange.fromJSON(e))
        : [],
...
export const DescriptorProtoExtensionRange = {
  encode(message: DescriptorProtoExtensionRange, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.start !== 0) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): DescriptorProtoExtensionRange {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create(base?: DeepPartial<DescriptorProtoExtensionRange>): DescriptorProtoExtensionRange {
    return DescriptorProtoExtensionRange.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<DescriptorProtoExtensionRange>): DescriptorProtoExtensionRange {
    const message = createBaseDescriptorProtoExtensionRange();
...
export const DescriptorProtoReservedRange = {
  encode(message: DescriptorProtoReservedRange, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.start !== 0) {
      writer.uint32(8).int32(message.start);
    }
    if (message.end !== 0) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): DescriptorProtoReservedRange {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create(base?: DeepPartial<DescriptorProtoReservedRange>): DescriptorProtoReservedRange {
    return DescriptorProtoReservedRange.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<DescriptorProtoReservedRange>): DescriptorProtoReservedRange {
    const message = createBaseDescriptorProtoReservedRange();
    message.start = object.start ?? 0;
    message.end = object.end ?? 0;
    return message;
...
export const EnumDescriptorProto = {
  ...
  fromJSON(object: any): EnumDescriptorProto {
    return {
      ...
      reservedRange: globalThis.Array.isArray(object?.reservedRange)
        ? object.reservedRange.map((e: any) => EnumDescriptorProtoEnumReservedRange.fromJSON(e))
        : [],
      reservedName: globalThis.Array.isArray(object?.reservedName)
        ? object.reservedName.map((e: any) => globalThis.String(e))
        : [],
...
export const EnumDescriptorProtoEnumReservedRange = {
  encode(message: EnumDescriptorProtoEnumReservedRange, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.start !== 0) {
      writer.uint32(8).int32(message.start);
    }
    if (message.end !== 0) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): EnumDescriptorProtoEnumReservedRange {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create(base?: DeepPartial<EnumDescriptorProtoEnumReservedRange>): EnumDescriptorProtoEnumReservedRange {
    return EnumDescriptorProtoEnumReservedRange.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<EnumDescriptorProtoEnumReservedRange>): EnumDescriptorProtoEnumReservedRange {
    const message = createBaseEnumDescriptorProtoEnumReservedRange();
    message.start = object.start ?? 0;
    message.end = object.end ?? 0;
    return message;
...
export const FileOptions = {
  ...
  fromJSON(object: any): FileOptions {
    return {
      ...
      optimizeFor: isSet(object.optimizeFor) ? fileOptionsOptimizeModeFromJSON(object.optimizeFor) : 1,
...
export const UninterpretedOptionNamePart = {
  encode(message: UninterpretedOptionNamePart, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.namePart !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): UninterpretedOptionNamePart {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create(base?: DeepPartial<UninterpretedOptionNamePart>): UninterpretedOptionNamePart {
    return UninterpretedOptionNamePart.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<UninterpretedOptionNamePart>): UninterpretedOptionNamePart {
    const message = createBaseUninterpretedOptionNamePart();
...
export const SourceCodeInfoLocation = {
  encode(message: SourceCodeInfoLocation, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): SourceCodeInfoLocation {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create(base?: DeepPartial<SourceCodeInfoLocation>): SourceCodeInfoLocation {
    return SourceCodeInfoLocation.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<SourceCodeInfoLocation>): SourceCodeInfoLocation {
    const message = createBaseSourceCodeInfoLocation();
...
export const GeneratedCodeInfoAnnotation = {
  encode(message: GeneratedCodeInfoAnnotation, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    writer.uint32(10).fork();
    for (const v of message.path) {
      writer.int32(v);
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): GeneratedCodeInfoAnnotation {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create(base?: DeepPartial<GeneratedCodeInfoAnnotation>): GeneratedCodeInfoAnnotation {
    return GeneratedCodeInfoAnnotation.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<GeneratedCodeInfoAnnotation>): GeneratedCodeInfoAnnotation {
    const message = createBaseGeneratedCodeInfoAnnotation();
    message.path = object.path?.map((e) => e) || [];
